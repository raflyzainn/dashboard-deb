...
export const mapProposal = (r: RecordModel): ProposalVersion => ({ reviewNote: r.reviewNote || undefined, reviewedAt: r.reviewedAt ? date(r.reviewedAt) : undefined, reviewedBy: r.reviewedBy || undefined, reviewRevision: r.reviewRevision || 0, id: r.id, campusId: r.campus, version: r.version, filename: r.filename, size: r.size, changes: r.changes, createdAt: date(r.created), simulated: r.simulated });
