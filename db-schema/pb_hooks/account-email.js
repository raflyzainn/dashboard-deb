...
<tr><td bgcolor="#185bd6" style="padding:30px 28px;color:#ffffff;border-radius:16px 16px 0 0"><div style="font-size:30px;font-weight:700;letter-spacing:2px">DEB<span style="font-size:12px;font-weight:400;letter-spacing:0"> &nbsp; / &nbsp; Pertamina Foundation</span></div><div style="margin-top:10px;font-size:10px;letter-spacing:2px;color:#d7e8ff">RUANG TUMBUH BERSAMA</div></td></tr>
