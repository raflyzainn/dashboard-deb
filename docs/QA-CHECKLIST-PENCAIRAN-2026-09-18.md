...
- Dashboard dan halaman Pencairan Keuangan dapat mencari nama kampus dan memfilter seluruh pengajuan berdasarkan delapan tahap; dropdown kampus serta detail mengikuti hasil. Kombinasi tanpa hasil menampilkan satu kartu kosong dengan tombol Reset filter tanpa dropdown kosong atau ajakan unggah proposal, dan tampilan tetap responsif pada lebar 390 px.
