...
- Dashboard dan halaman Pencairan Keuangan dapat mencari nama kampus dan memfilter seluruh pengajuan berdasarkan delapan tahap; dropdown kampus serta detail mengikuti hasil, kombinasi tanpa hasil menampilkan kondisi kosong, dan tampilan tetap responsif pada lebar 390 px.
