...
- [x] **B6 — Pencarian kampus dan filter tahap.** Dashboard dan halaman Pencairan Keuangan dapat mencari pengajuan berdasarkan nama kampus dan memfilternya menggunakan delapan tahap pencairan. Jumlah hasil, dropdown kampus, detail pengajuan, dan kondisi kosong diperbarui mengikuti kombinasi filter. Bukti: [dashboard Keuangan](../src/routes/(app)/finance/dashboard/+page.svelte), [halaman Pencairan](../src/lib/components/shared/payments/Payments.svelte).
