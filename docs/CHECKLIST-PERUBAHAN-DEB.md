...
- [x] **B6 — Pencarian kampus dan filter tahap.** Dashboard Keuangan menampilkan seluruh pengajuan yang dapat dicari berdasarkan nama kampus dan difilter menggunakan delapan tahap pencairan. Jumlah hasil dan kondisi kosong diperbarui mengikuti kombinasi filter. Bukti: [dashboard Keuangan](../src/routes/(app)/finance/dashboard/+page.svelte).
